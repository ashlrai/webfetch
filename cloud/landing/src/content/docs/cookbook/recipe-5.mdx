...
> **Try it:** drop your `WEBFETCH_API_KEY` (free at [app.getwebfetch.com/signup](https://app.getwebfetch.com/signup)) into Claude Code's MCP config and you're fetching inside your chat in under a minute.
...
- Claude can pick from 24 providers, not just Unsplash — better stylistic fit for technical or editorial posts.
