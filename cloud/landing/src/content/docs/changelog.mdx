...
### Federated search across 25 providers
...
Canonical tags: `CC0`, `PUBLIC_DOMAIN`, `CC_BY`, `CC_BY_SA`, `UNSPLASH_LICENSE`, `PEXELS_LICENSE`, `PIXABAY_LICENSE`, `EDITORIAL_LICENSED`, `PRESS_KIT_ALLOWLIST`, `UNKNOWN`. Ranking by license, then confidence, then resolution. Default `licensePolicy: "safe-only"` rejects `UNKNOWN` entirely.
