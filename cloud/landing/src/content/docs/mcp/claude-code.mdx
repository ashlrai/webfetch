...
Claude should call the webfetch `search_images` tool. To inspect provider coverage outside MCP, run `webfetch providers`; the canonical registry has 24 providers and 19 defaults.
