...
Claude should call the webfetch `search_images` tool. To inspect provider coverage outside MCP, run `webfetch providers`; the canonical registry has 25 providers and 19 defaults.
...
- **"Cannot find module 'webfetch-mcp'"** — first invocation downloads via npx. If your machine is offline, install globally: `npm install -g getwebfetch-mcp`.
