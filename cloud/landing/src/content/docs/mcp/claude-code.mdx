...
![Claude Code webfetch tool call screenshot placeholder](/docs/img/claude-code-mcp-placeholder.png)

_The tool inspector panel shows each `search_images` call with its arguments, provider reports, and returned candidates._
