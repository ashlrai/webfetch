...
All six use the same underlying MCP binary (`getwebfetch-mcp`), just wired up differently.
...
- **"Spawn ENOENT"** — the IDE can't find the MCP binary. Use `npx -y getwebfetch-mcp` instead of a direct path.
