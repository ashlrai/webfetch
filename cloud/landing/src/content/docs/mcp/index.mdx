...
No telemetry is collected in the CLI / MCP binary. The Cloud API collects standard request metadata; see the [telemetry docs](/docs/faq#telemetry) and [PRIVACY.md](https://github.com/ashlrai/web-fetcher-mcp/blob/main/PRIVACY.md).
