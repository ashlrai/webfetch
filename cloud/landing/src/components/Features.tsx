    ...
    <svg viewBox="0 0 320 160" className="w-full h-auto" aria-hidden>
      ...
      {[
        ...
        <g key={n.l}>
          ...
          <text x={n.x + 7} y={n.y + 3} fontFamily="ui-monospace,Menlo" fontSize="8" fill="#8a8a95">
            {n.l}
          </text>
        </g>
      ))}
...
function IllBrowser() {
  return (
    <svg viewBox="0 0 320 160" className="w-full h-auto" aria-hidden>
      ...
      <text x="96" y="42" fontFamily="ui-monospace,Menlo" fontSize="7" fill="#8a8a95">
        images.google.com/search?q=
      </text>
      <text x="200" y="42" fontFamily="ui-monospace,Menlo" fontSize="7" fill="#ff5a1f">
        drake portrait
      </text>
      {/* result tiles */}
      ...
      {/* cursor */}
      <path
        d="M 180 88 L 180 102 L 184 98 L 188 106 L 191 104 L 187 97 L 192 96 Z"
        fill="#ff5a1f"
        stroke="#0a0a0c"
        strokeWidth="0.5"
      />
    ...
    <svg viewBox="0 0 320 160" className="w-full h-auto" aria-hidden>
      ...
      <g transform="translate(56,24)">
        ...
        <rect
          ...
          strokeOpacity="0.4"
        />
        <text x="10" y="94" fontFamily="ui-monospace,Menlo" fontSize="8" fill="#8a8a95">
          drake.jpg
        </text>
        <text x="10" y="104" fontFamily="ui-monospace,Menlo" fontSize="7" fill="#4a4a55">
          + XMP
        </text>
      </g>
      {/* sidecar */}
      <g transform="translate(172,24)">
        ...
        <text x="8" y="16" fontFamily="ui-monospace,Menlo" fontSize="7" fill="#ff5a1f">
          drake.jpg.xmp
        </text>
  ...
  return (
    <svg viewBox="0 0 320 160" className="w-full h-auto" aria-hidden>
      ...
      <text
        ...
        fill="#8a8a95"
      >
        opt-in · local-first · zero trackers
      </text>
    </svg>
  );
}
