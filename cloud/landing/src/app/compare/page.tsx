      ...
      <div className="mt-16 space-y-10 prose-wf">
        <div>
          ...
          <p>
            ...
            (browser fallback, opt-in), and only after trying direct licensed sources that Google
            doesn't surface.
          </p>
        </div>
        <div>
          ...
          <p>
            Unsplash is excellent — it's one of our 25 providers. But Unsplash alone can't cover
        ...
        <div>
          ...
          <p>
            ...
            no license data. webfetch uses them (opt-in) as part of its 25-provider registry and attaches a
