...
Show HN: Webfetch – license-first image search for AI agents (MCP, 25 providers)
...
Happy to dig into the license-first ranker, the 25-provider failover topology, EXIF/IPTC/XMP license extraction, the DCT perceptual-hash dedupe, or the pricing.

## Pre-submit checklist

- [ ] Repo public, README above the fold
- [ ] `getwebfetch.com` returns 200 and the install script hash matches the docs
- [ ] `npx -y getwebfetch-mcp` returns a valid `tools/list` in <5s
