...
const DRAKE_ENTRIES: Array<GalleryEntry & { altSourceUrl?: string }> = [
  {
    ...
    altSourceUrl:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Drake_July_2016.jpg?width=800",
    ...
    attributionLine:
      "The Come Up Show · CC BY-SA 2.0 · via Wikimedia Commons",
    fetchedInMs: 298,
  },
  {
    file: "drake-performing.jpg",
    // Drake at Bluesfest, Ottawa. Cropped version.
    sourceUrl:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Drake_Bluesfest_(cropped).jpg?width=1200",
    altSourceUrl:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Drake Bluesfest (cropped).jpg?width=1200",
    pageUrl:
      "https://commons.wikimedia.org/wiki/File:Drake_Bluesfest_(cropped).jpg",
    license: "CC-BY-SA",
  ...
  },
  {
    ...
    // Drake at the Carter Effect premiere, TIFF 2017. Cropped.
    sourceUrl:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Drake_at_The_Carter_Effect_2017_(36818935200)_(cropped).jpg?width=1200",
    altSourceUrl:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Drake at The Carter Effect 2017 (36818935200) (cropped).jpg?width=1200",
    pageUrl:
    ...
    attributionLine:
      "GabboT · CC BY-SA 2.0 · via Openverse / Wikimedia Commons",
    fetchedInMs: 276,
  },
];
